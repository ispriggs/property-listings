// Valle Vivo — notify-booking-cancelled Edge Function
    ...
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px">
        ...
        <tr><td style="background:#ffffff;border-radius:16px;padding:36px 40px;border:1px solid #ebe2d3">
          ...
          <p style="margin:0 0 6px;font-size:.8rem;font-weight:600;letter-spacing:.1em;text-transform:uppercase;color:#9e9589">Booking Cancelled</p>
          ...
          <p style="margin:0 0 24px;font-size:.875rem;color:#6e6a63">
